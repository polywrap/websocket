...
import { WebSocket_Message } from "./types/wrap";
...
describe("WebSocket plugin", () => {
  ...
  describe("cache", () => {
    ...
    it("should receive a message", async () => {
      ...
      const response = await polywrapClient.invoke<WebSocket_Message[]>({
        uri: "wrap://ens/ws.polywrap.eth",
        method: "receive",
        args: {
          id: result.value,
    ...
    it("should receive messages in batches", async () => {
      ...
      const response1 = await polywrapClient.invoke<WebSocket_Message[]>({
        uri: "wrap://ens/ws.polywrap.eth",
        method: "receive",
        args: {
          id: result.value,
      ...
      const response2 = await polywrapClient.invoke<WebSocket_Message[]>({
        uri: "wrap://ens/ws.polywrap.eth",
        method: "receive",
        args: {
          id: result.value,
      ...
      const response3 = await polywrapClient.invoke<WebSocket_Message[]>({
        uri: "wrap://ens/ws.polywrap.eth",
        method: "receive",
        args: {
          id: result.value,
