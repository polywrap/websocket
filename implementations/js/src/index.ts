...
export class WsPlugin extends Module<NoConfig> {
  ...
  private _callbacks: Record<string, (msg: WebSocket_Message) => void> = {};
  private _caches: Record<number, WebSocket_Message[]> = {};
  private _mutex = true;
  ...
  private _callbackId(callback: WebSocket_Callback): string {
